...
-- ----------------------------------------------------SELECT--------------------------------------------------------
/*
Descripción: Esta consulta obtiene todos los registros de la tabla Clientes, 
mostrando todos los campos:
ID_Cliente, Nombre, Email, Telefono, Fecha_Registro, y ID_Direccion.
*/
...
-- ----------------------------------------------------WHERE--------------------------------------------------------
/*
Descripción: Esta consulta obtiene los nombres, correos electrónicos, 
y la fecha de registro de los clientes que se registraron después del 10 de enero de 2024.
*/
...
La consulta devuelve el nombre del cliente, el nombre del producto
que compró, la cantidad adquirida y la fecha en que se realizó el pedido.
*/
SELECT
...
/*
JOIN conecta las tablas Productos y Pedidos_Productos para asociar los productos
con los pedidos en los que se han vendido.
La consulta usa SUM para calcular el total de unidades vendidas y el total de 
ingresos generados por cada producto.
GROUP BY agrupa los resultados por el nombre del producto, asegurando que obtengas 
el total de ventas y ganancias por producto.
*/
SELECT
    Productos.Nombre AS Producto,
...
-- Devuelve todos los productos cuyo precio está entre 100 y 500 (inclusivo).
...
-- Devuelve todas las direciiones donde el còdigo postal sea nulo.
...
-- Devuelve todas las direcciones donde el código postal no sea nulo.

/*
LIKE:
-- Se utiliza para buscar un patrón en una cadena de texto.
*/
SELECT * FROM Clientes WHERE Nombre LIKE 'Juan%';
-- Devuelve todos los clientes cuyos nombres comienzan con "Juan".
-- El símbolo % es un comodín que representa cualquier secuencia de caracteres.
...
/*
NOT LIKE:
-- Se utiliza para excluir un patrón en una cadena de texto.
*/
